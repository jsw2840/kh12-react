...
const BookInfinite = (props)=>{
    ...
    const loadBook = ()=>{
        loading.current=true; //로딩중 으로 설정 (순서보장)
        axios({
    ...
    //개수가 변하면 페이지를 1로, 목록을 모두 지우고 다시 불러야 한다
    useEffect(()=>{
        setPage(1);
        setBookList([]);
        // loadBook();
    ...
    /////////////////////////////////////////////////////////////
    //  스크롤 이벤트 처리(scroll event handing)
    ...
    return(
        ...
        <div className="row">
            <div className="col">
            <h1 className="text-center">무한 스크롤 예제</h1>
            </div>
        </div>
